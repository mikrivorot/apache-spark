...
<img src="../docs/screenshots/pearson_correlation.png" width="50%">



Result (first 5) on `scoreThreshold = 0.5` and `numberOfSharedRatings = 100`:

<img src="../docs/screenshots/pearson_correlation_recommendations_1.png" width="70%">


#### Execution results
Result (first 10) on `scoreThreshold = 0.3` and `numberOfSharedRatings = 100`:

<img src="../docs/screenshots/pearson_correlation_recommendations_2.png" width="70%">
...
<img src="../docs/screenshots/pearson_formula.png" width="50%">
...
<img src="../docs/screenshots/adjusted_cosine_similarity.png" width="70%">

#### Theory
<img src="../docs/screenshots/cosine_theory.png" width="50%">
<img src="../docs/screenshots/adjusted_cosine_theory.png" width="50%">
...
#### Theory
<img src="../docs/screenshots/euclidean_theory.png" width="50%">
...
<img src="../docs/screenshots/jaccard_results_1.png" width="70%">
...
`minSharedRatings = 240` (as scope=1 for top resluts, I sorted by shared raitings)
<img src="../docs/screenshots/jaccard_results_2.png" width="70%">

#### Theory
<img src="../docs/screenshots/jaccard_theory.png" width="50%">